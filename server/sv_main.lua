...
lib.callback.register('KF_PauseMenu:GetPlayerData', function(src)
  if Config.Framework == 'esx' then
    ...
    local playerData = {
      ...
      ['moneyCash'] = xPlayer.getMoney() or 0,
      ['moneyBank'] = xPlayer.getAccount('bank').money or 0,
    }
  ...
  elseif Config.Framework == 'qbcore' then
    ...
    local playerData = {
      ...
      ['moneyCash'] = xPlayer.PlayerData.money.cash or 0,
      ['moneyBank'] = xPlayer.PlayerData.money.bank or 0,
    }
